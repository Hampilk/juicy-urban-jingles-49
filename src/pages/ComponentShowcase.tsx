...
import { componentCategories, ComponentData, getTotalComponentCount } from '@/data/showcase';
    ...
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-gradient-to-b from-gray-950 via-gray-950 to-black">
        ...
        <SidebarInset>
          ...
          <Routes>
            <Route path="/" element={searchQuery ? <SearchResults searchQuery={searchQuery} filteredComponents={filteredComponents} /> : <ShowcaseHome totalComponents={totalComponents} />} />
